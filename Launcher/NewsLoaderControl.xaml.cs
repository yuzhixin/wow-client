...
namespace Launcher
{
    ...
    public partial class NewsLoaderControl
    {
        ...
        private void ChangeNewsItem(bool next)
        {
            ...
            Storyboard.SetTarget(sb ?? throw new InvalidOperationException("找不到资源 \"ChangeItemsBegin\""), MainGrid);
        ...
        private void StoryBoard_Completed(object sender, EventArgs e)
        {
            ...
            Storyboard.SetTarget(sb ?? throw new InvalidOperationException("找不到资源 \"ChangeItemsEnd\""), MainGrid);
            sb.Begin();
